...
/* harmony default export */ var store = (store_VXEStore);
  ...
  getCellLabel: function getCellLabel(row, column, params) {
    ...
    if (params && formatter) {
      ...
      if (xe_utils_amd_xe_utils_default.a.isString(formatter)) {
        ...
        var _globalFunc2 = src_formats.get(formatter[0]) || xe_utils_amd_xe_utils_default.a[formatter[0]];
...
function getFormatDate(value, props, defaultFormat) {
  return xe_utils_amd_xe_utils_default.a.toDateString(parseDate(value, props), props.labelFormat || defaultFormat);
}
...
function getDefaultProps(_ref3, _ref4, defaultProps) {
  ...
  return xe_utils_amd_xe_utils_default.a.assign($table.vSize ? {
    size: $table.vSize
...
function getDefaultFormItemProps(_ref8, _ref9, defaultProps) {
  ...
  return xe_utils_amd_xe_utils_default.a.assign($form.vSize ? {
    size: $form.vSize
  } : {}, defaultCompProps, defaultProps, props);
}
/**
...
var menus_commands = new store();
/* harmony default export */ var menus = (menus_commands);
...
function renderDateDayTable(h, _vm) {
  ...
  return [h('table', {
    ...
    return h('th', conf.i18n("vxe.input.date.weeks.w".concat(day)));
    ...
    return h('tr', rows.map(function (item) {
      return h('td', {
        class: {
          ...
          'is--next': item.isNext,
          'is--selected': xe_utils_amd_xe_utils_default.a.isDateSame(dateValue, item.date, 'yyyy-MM-dd'),
          'is--hover': xe_utils_amd_xe_utils_default.a.isDateSame(datePanelValue, item.date, 'yyyy-MM-dd')
        },
        on: {
          click: function click() {
...
function renderDateMonthTable(h, _vm) {
  ...
  return [h('table', {
    ...
    return h('tr', rows.map(function (item) {
      return h('td', {
        class: {
          'is--hover': xe_utils_amd_xe_utils_default.a.isDateSame(datePanelValue, item.date, 'MM')
        },
        on: {
          click: function click() {
            return _vm.dateSelectEvent(item);
...
function renderDateYearTable(h, _vm) {
  ...
  return [h('table', {
    ...
    return h('tr', rows.map(function (item) {
      return h('td', {
        class: {
          'is--hover': xe_utils_amd_xe_utils_default.a.isDateSame(datePanelValue, item.date, 'yyyy')
        },
        on: {
          click: function click() {
            return _vm.dateSelectEvent(item);
...
/* harmony default export */ var input = ({
  ...
  computed: {
    ...
    dateValue: function dateValue() {
      ...
      return value ? xe_utils_amd_xe_utils_default.a.toStringDate(value, this.dateLabelFormat) : null;
    },
    ...
    weekDatas: function weekDatas() {
      var startWeek = xe_utils_amd_xe_utils_default.a.toNumber(this.startWeek);
      var weeks = [startWeek];
  ...
  methods: {
    ...
    afterCheckValue: function afterCheckValue() {
      ...
      if (isNumber) {
        if (inpVal) {
          if (type === 'integer') {
            inpVal = xe_utils_amd_xe_utils_default.a.toInteger(inpVal);
          } else {
            inpVal = xe_utils_amd_xe_utils_default.a.toNumber(inpVal);
          }
    ...
    numberChange: function numberChange(isPlus) {
      ...
      var num = this.type === 'integer' ? xe_utils_amd_xe_utils_default.a.toInteger(value) : xe_utils_amd_xe_utils_default.a.toNumber(value);
    ...
    dateParseValue: function dateParseValue(date) {
      ...
      var dValue = date ? xe_utils_amd_xe_utils_default.a.toStringDate(date, parseFormat) : null;
      var dLabel = '';
    ...
    dateChangeValue: function dateChangeValue(date) {
      ...
      var inpVal = valueFormat ? xe_utils_amd_xe_utils_default.a.toDateString(date, valueFormat) : date;
  ...
  methods: {
    ...
    setCurrentOption: function setCurrentOption(option) {
      ...
      if (option) {
        ...
        this.$nextTick(function () {
          DomTools.toView(_this.$refs.panel.querySelector("[data-option-id='".concat(option.id, "']")));
        });
      }
    },
...
/* harmony default export */ var export_panel = ({
  ...
  render: function render(h) {
    ...
    }, conf.i18n('vxe.export.expPrint')), h('vxe-button', {
      props: {
        status: 'primary'
      },
      on: {
