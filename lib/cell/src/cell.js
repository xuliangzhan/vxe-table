...
var Cell = {
  ...
  renderRadioHeader: function renderRadioHeader(h, params) {
    ...
    return [h('span', {
      class: 'vxe-cell--title'
    }, slots && slots.header ? slots.header.call($table, params, h) : _tools.UtilTools.formatText(_tools.UtilTools.getFuncText(own.title || own.label), 1))];
  },
  ...
  renderSelectionHeader: function renderSelectionHeader(h, params) {
    ...
    if (checkboxOpts.checkStrictly ? !checkboxOpts.showHeader : checkboxOpts.showHeader === false) {
      return [h('span', {
        class: 'vxe-cell--title'
      }, slots && slots.header ? slots.header.call($table, params, h) : _tools.UtilTools.getFuncText(headerTitle))];
    }
